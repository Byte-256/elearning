...
export default function Signup() {
  ...
  function userSignup(data: FormData) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden loginbody">
      <div className="w-full p-6 primary-50 rounded-3xl drop-shadow-xl lg:max-w-xl">
        <h1 className="text-3xl font-bold text-center text-gray-700">{auth.currentUser?.displayName}</h1>
        <form className="mt-6" action={userSignup}>
          {/* Username */}
          <div className="mb-4">
            <label
              htmlFor="email"
        ...
        <div className="flex mt-4 gap-x-2">
          ...
          <Button
            type="button"
            className="primary-500 hover:primary-500 flex items-center justify-center w-full p-2 rounded-md"
          >
            <svg
